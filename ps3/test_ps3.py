...
def test_substitute_hand(word_list):
    """
    Unit test for substitute_hand
    """
    # case for dict containing alphabet excluding a for keys with b to sub returns a dict with keys a,c-z
    # case for dict containing a singular key with a value of n, n>1 returns a a dict containing a different key with a value of n
    # case for letter to be subbed is not in dict
